    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                ...
                <?php $name=ucfirst($member->fname); echo"Hi $name" ?><span class="caret"></span>
            </a>

            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                {{-- @foreach($modals as $modal)
                    @if ($modal->members_id==$member->id)
                        <a class="dropdown-item" href="{{route('memberprofile.edit',$member->id)}}"> <img id="size"
                            src="{{asset('/image/member/'.$modal->image)}}" alt="nothing to show">Profile</a>
                    @break
                    @endif
                @endforeach --}}
                ...
                @foreach ($modals as $modal )
                @if($modal->members_id==$member->id)
                <a class="dropdown-item" href="{{route('memberprofile.edit',$member->id)}}" id="profile"> <img id="size"
                src="{{asset('/image/member/'.$modal->image)}}" alt="nothing to show">Profile</a>
                @break
                @endif
                @endforeach
                @else
                <a class="dropdown-item" href="{{route('memberprofile.edit',$member->id)}}" id="profile">Profile</a>
                @endif
