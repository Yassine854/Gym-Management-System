...
<div class="card card-danger" style="background-color: rgb(250, 218, 181)">
    ...
    @endif
    <!-- form start -->
    <form id="quickForm" method="post" action="{{route('profile.update',$coach->id)}}">
      @csrf
      @method('PUT')
        <div class="card-body">
        <div class="form-group">
          <label for="cin"><b style="color: red">*</b>CIN:</label>
          <input readonly type="number" name="cin" value="{{$coach->cin}}"class="form-control" id="cin" placeholder="Enter coach's CIN">
        </div>

        <div class="form-group">
            <label for="fname"><b style="color: red">*</b>First Name:</label>
            <input type="text" name="fname" value="{{$coach->fname}}"class="form-control" id="fname" placeholder="Enter coach's First Name">
          </div>

          <div class="form-group">
            <label for="lname"><b style="color: red">*</b>Last Name:</label>
            <input type="text" name="lname" value="{{$coach->lname}}"class="form-control" id="lname" placeholder="Enter coach's Last Name">
          </div>
        ...
        <div class="form-group">
            ...
            <input type="number" step="0.01" name="height" value="{{$coach->height}}"class="form-control" id="height">
          </div>

          <div class="form-group">
            <label for="weight">Weight:</label>
            <input type="number" step="0.01" name="weight" value="{{$coach->weight}}"class="form-control" id="weight">
          </div>

          <div class="form-group">
            <label for="address"><b style="color: red">*</b>Address:</label>
            <input type="text" name="address" value="{{$coach->address}}"class="form-control" id="address" placeholder="Enter coach's address">
          </div>
